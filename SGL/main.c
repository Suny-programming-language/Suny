...
SUNY_API struct Sframe* Smain(struct Sframe* frame, struct Scompiler* compiler) {
    SunyInitialize_c_api_func(frame, compiler, 11, "init", 3, Sinit);
    SunyInitialize_c_api_func(frame, compiler, 12, "screen_fill", 3, Sscreen_fill);
    SunyInitialize_c_api_func(frame, compiler, 13, "flip", 0, Sflip);
    SunyInitialize_c_api_func(frame, compiler, 14, "close", 0, Sclose);
    SunyInitialize_c_api_func(frame, compiler, 15, "draw_square", 6, Sdraw_square_api);
    SunyInitialize_c_api_func(frame, compiler, 16, "draw_rect", 7, Sdraw_rect_api);
    SunyInitialize_c_api_func(frame, compiler, 17, "draw_line", 7, Sdraw_line_api);
    SunyInitialize_c_api_func(frame, compiler, 18, "get_key", 0, Sget_key_api);
